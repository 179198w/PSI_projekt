	...
	<ol class="breadcrumb">
		...
		<div class="left-panel panel panel-primary">
			...
			<div class="panel-body">
				<input type="button" value="Stwórz" onclick="window.location='${basepath}/dodaj-miasto'" class="margin-auto margin-top-10 display-block btn btn-lg btn-default" />
			</div>
		</div>
					...
					<tbody>
						<c:forEach var="city" items="${cities}">
							<tr>
								...
								<td class="fit-cell-to-content"><input type="button" onclick="editCity(${city.id});" value="edytuj" class="btn btn-xs btn-default" /> <input type="button"
									onclick="removeCity(${city.id});" value="usuń" class="btn btn-xs btn-default" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
